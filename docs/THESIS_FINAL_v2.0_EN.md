...
Each dataset was used with its official train/val/test split unchanged. The QA-pair counts are those of the distributed datasets; all reported accuracies are computed on the full test split of each dataset (PathVQA 6,719 / SLAKE 1,061 / VQA-RAD 451; 8,231 items in total). See Section 4.1.
