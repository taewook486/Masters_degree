...
## 🔴 2026-08-17 — v2 재실험 **전멸 → 원인 규명 후 재가동 + 성능 패치** (완료 예상 8/20 아침 UTC)
...
성능 패치 적용 후 실측 **약 22분/trial**. 8/17 12:09 기준 19/200 완료, 남은 181 trial × 22분 ≈ **67시간 → 8/20 아침(UTC, 한국시간 8/20 오후) 완료 예상**. (패치 전 기준은 30.3분/trial·101시간이었다.) 완료 후 작업은 아래 08-16 (3차) 절 마지막 항목(분석 스크립트 전략 목록 추가 / 5조건 통합 분석 / **고유 조합 12.5→20 검증** / 논문 §4.3·§5.3(8)·§5.4 갱신) 그대로다.
