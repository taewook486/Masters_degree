...
**아직 안 한 것**: `results/phase1_baseline/phase1_robustness.json` 재생성.
`python -m scripts.robustness_phase1`로 되지만 커밋된 산출물을 덮어쓰므로 남겨 뒀습니다.
이걸 돌려야 저장본과 논문 수치가 완전히 일치합니다.
